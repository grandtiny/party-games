...
当前共有 235 个稳定功能 ID（不含 `D-*` 决策）：已实现 105、部分实现 19、特殊实现 23、未实现 35、
...
| CAT-09 | 音效和动画 | 部分实现 | SWF 内动画和可兼容音效由 Ruffle 播放；未做逐文件音频验收，也未恢复所有活动模块。 | `categories.csv`、Ruffle 运行时 |
...
| 分类 | 稳定 ID | 尚未覆盖的主要差异 |
| --- | --- | --- |
| 目录与素材 | CAT-02、CAT-03、CAT-04、CAT-06、CAT-09、CAT-10、CAT-11 | 配置目录数量仍有差额；音频、社交头像及未启用活动没有逐项运行验收。 |
