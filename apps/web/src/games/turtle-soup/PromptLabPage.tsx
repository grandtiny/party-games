    ...
    >
      <div className="turtle-lab">
        <section className="turtle-lab-section">
          ...
          <div className="turtle-lab-prompt-version">
            Prompt 版本：{TURTLE_SOUP_PROMPT_VERSION}
          </div>
